...
3. Sections 1-4 must be 800-1000 words with MINIMUM 3 properly formatted markdown tables
4. Section 5 (aiInsights) must be 600-800 words with MINIMUM 2 properly formatted markdown tables
...
aiInsights - 🤖 AI-Powered Deep Insights & Predictions (CLEARLY LABELED AS AI ANALYSIS):
MUST start with: "🤖 **AI Deep Analysis Note**: The following insights are generated by Qwen3-Max AI based on real-time data analysis and predictive modeling. These represent AI-driven conclusions and forecasts."

This section should include:
- **Trend Predictions**: Based on latest data, predict 6-12 month business trends with quantified probabilities
- **Strategic Opportunities**: AI-identified potential opportunities the market may be underestimating
- **Risk Alerts**: AI-detected early warning signals and emerging risks
- **Scenario Analysis**: Best/Base/Worst case scenarios with specific triggers and probability estimates
- **AI Investment Thesis**: Independent AI perspective on investment timing and positioning
- **Market Sentiment Analysis**: AI assessment of current market positioning vs fundamentals

- REQUIRED 2 TABLES (clean markdown with | separators):
  * Table 1: AI Scenario Analysis
    Example:
  ...
  * Table 2: AI Risk-Opportunity Matrix
    Example:
...
CRITICAL: This section MUST be clearly labeled as AI-generated analysis throughout!
...
4. Create 3 tables per section for sections 1-4, and 2 tables for section 5 (14 tables total)
5. Return ONLY valid JSON with FIVE sections
6. Sections 1-4: 800-1000 words each
7. Section 5 (aiInsights): 600-800 words
8. CRITICAL: Section 5 MUST clearly indicate it's AI-generated analysis!
